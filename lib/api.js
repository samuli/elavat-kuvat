...
const searchUrl = (lookfor, page = 1, topic, genre, daterange, resultCount = limit, recFields = ['title','id','images']) => {
...
const frontPageUrl = () => {
  ...
  const queryFilters = filters(false    )
...
const recordFields = ['title','id','images', 'urls', 'recordPage', 'imageRights', 'topics', 'buildings', 'rawData'];
const recordUrl = (id) => {
